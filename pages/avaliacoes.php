...
<header class="hero-section" style="background: url(../img/sliderbarcliente.jpg) center/cover no-repeat; height: 400px; display: flex; align-items: center; color: black; text-shadow: 2px 2px 4px rgba(0,0,0,);">
    <div class="container">
